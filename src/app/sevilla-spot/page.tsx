...
export default function SevillaSpotPage() {
  ...
  const spot = {
    name: t('sites.giralda.name'),
    trainer: t('sites.giralda.guide'),
    nextSpots: "1 " + t('nav.of') + " 6",
    coordinates: "37.3862,-5.9925", // Coordenadas de La Giralda
    currentSpot: {
    ...
    description: t('sites.giralda.description')
  };
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#1a1a1a', width: '100vw', position: 'relative', overflow: 'hidden' }}>
      ...
      <Box sx={{ 
        ...
        top: 0,
        left: 0,
        backgroundImage: 'url(/img/Giralda.jpg), linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.7) 100%)',
