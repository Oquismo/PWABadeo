export interface Project {
  ...
  description: string;
  imageUrl: string;
  longDescription?: string; // Añadimos un campo para el texto largo
}
...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: 'Talleres de arte, música y teatro para revitalizar la vida cultural.',
  ...
  // Añadimos los otros proyectos que teníamos en la lista completa
  {
    id: 'deporte-para-todos',
    title: 'Deporte para Todos',
    description: 'Organización de ligas deportivas y actividades físicas.',
