...
export const barrioDeTasks: TaskData[] = [
  {
    title: 'Acreditación Erasmus+',
    description: 'Renovación de certificaciones europeas',
    progress: 75,
  ...
  {
    title: 'Preparación Cultural',
    description: 'Sesiones pre-partida para estudiantes',
    progress: 92,
  ...
  {
    title: 'Monitoreo Tirocini',
    description: 'Seguimiento de prácticas en empresas',
    progress: 68,
  ...
  },
  {
    ...
    description: 'Desarrollo de partnerships corporativos',
    progress: 52,
  ...
  },
  {
    ...
    description: 'Encuentros entre participantes y profesionales',
    progress: 80,
  ...
  },
  {
    ...
    description: 'Organización de transporte aeropuerto-alojamiento',
    progress: 95,
  ...
  },
  {
    ...
    description: 'Gestión de visados y documentación',
    progress: 85,
  ...
  },
  {
    ...
    description: 'Actividades de integración lingüística',
    progress: 70,
  ...
  {
    title: 'Tutorías Personales',
    description: 'Seguimiento individual de participantes',
    progress: 88,
  ...
  },
  {
    ...
    description: 'Certificación y feedback de programas',
    progress: 60,
